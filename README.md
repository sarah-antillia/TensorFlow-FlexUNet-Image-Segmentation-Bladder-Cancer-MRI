<h2>TensorFlow-FlexUNet-Image-Segmentation-Bladder-Cancer-MRI (2026/09/20)</h2>

This is the first experiment of Image Segmentation for <b>Bladder-Cancer-MRI</b>
 based on
...
As shown below, the inferred masks resemble the ground-truth masks except for the third case. <br>
<br>
...
<br>
In this experiment, the training process was stopped at epoch 37 by EarlyStoppingCallback.<br>
<img src="./projects/TensorFlowFlexUNet/Bladder-Cancer/asset/train_console_output_at_epoch33.png" width="1024" height="auto"><br>
<br>
...
<img src="./projects/TensorFlowFlexUNet/Bladder-Cancer/asset/evaluate_console_output_at_epoch33.png" width="1024" height="auto">
...
The loss (categorical_crossentropy) on this Bladder-Cancer/test was not low, and dice_coef_multiclass was not high, as shown below.
<br>
<pre>
categorical_crossentropy,0.0324
dice_coef_multiclass,0.9817
</pre>
<br>
...
As shown below, the inferred masks look similar to the ground truth masks except for the fourth and fifth cases.<br>
<br>
<b>class_color_map = {Cancer: dark-red, Wall: green} </b><br><br>
<table>
<tr>
